...
// ===== The robust CHOICE-ONLY logic (from your file), now fed by user QA =====
...
// ---- Simple text-fill (kept separate; does NOT touch checkboxes/radios/selects)
...
// ---- Hotkey: Alt+2 fills text and then checkbox/radio/select using USER Q&A only
chrome.commands.onCommand.addListener(async (command) => {
  ...
  // 2) ONLY checkbox/radio/select from USER Q&A
  await chrome.scripting.executeScript({
    target: { tabId: tab.id, allFrames: true },
